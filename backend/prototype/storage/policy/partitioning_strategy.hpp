...
public:
    ...
    virtual bool performIdleMaintenance(uint32_t worker_id) = 0;
    ...
    virtual size_t getTotalEvictedPageCount() const = 0;
    virtual size_t getTotalDirtyWritePageCount() const = 0;
