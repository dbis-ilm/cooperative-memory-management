...
int main(int argc, char** argv) {
    ...
    int ret = 0;
    {
        ...
        DB db(FLAGS_memory_limit, path, false, FLAGS_no_dirty_writeback, !FLAGS_no_async_flush, !FLAGS_no_eviction_target, num_threads, FLAGS_exmap, true, std::move(partitioning_strategy));
